...
setenv QTDIR ${DRIVE_PATH}/usr/lib/qt3
...
setenv HUDSON_HOME ${DRIVE_PATH}/workspace/hudson
setenv JENKINS_HOME ${DRIVE_PATH}/jenkins
setenv TOMCAT_HOME ${DRIVE_PATH}/var/lib/tomcat7
...
setenv CROWD_HOME ${DRIVE_PATH}/var/crowd-home
...
setenv OPENGROK_TOMCAT_BASE ${DRIVE_PATH}/var/lib/tomcat7

# CMAKE 2.6.4
setenv CMAKE_HOME /usr/share/cmake-2.6.4
setenv CMAKE_ROOT ${CMAKE_HOME}

# PYTHON 27
setenv PYTHON_DIR /usr/lib/python
...
# SCONS 2.2.0
setenv SCONS_DIR /usr/lib/scons/SCons
...
# JBOSS
setenv JBOSS_HOME ${DRIVE_PATH}/workspace/jboss-as-7.1.1.Final
...
# TOMCAT
setenv CATALINA_HOME ${DRIVE_PATH}/usr/share/tomcat7
# Customize tomcat in CATALINA_BASE
setenv CATALINA_BASE ${DRIVE_PATH}/var/lib/tomcat7
...
# ECLIPSE 3.7
setenv ECLIPSE_HOME /workspace/eclipse-j2ee
...
setenv MD_HOME ${DRIVE_PATH}/MagicDraw-UML-16.5
setenv ANDROMDA_HOME ${DRIVE_PATH}/repo/org/andromda

# CHROME
setenv CHROME_BIN ${DRIVE_PATH}/usr/bin/google-chrome
